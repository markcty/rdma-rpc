...
```
cd existing_repo
git remote add origin https://ipads.se.sjtu.edu.cn:1312/distributed-rdma-serverless/rdma-rpc.git
git branch -M main
...
- [ ] [Set up project integrations](https://ipads.se.sjtu.edu.cn:1312/distributed-rdma-serverless/rdma-rpc/-/settings/integrations)
